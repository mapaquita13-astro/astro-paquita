...
if(!document.querySelector('script[src*="v157-editorial-guard.js"]')){
  const s=document.createElement('script');
  s.src='assets/v157-editorial-guard.js?v=158.2';
  s.async=false;
  s.setAttribute('data-ap-v157-editorial-guard','1');
  document.head.appendChild(s);
}
if(!document.querySelector('script[src*="v158-experience.js"]')){
  const s=document.createElement('script');
  s.src='assets/v158-experience.js?v=158.2';
  s.async=false;
  s.setAttribute('data-ap-v158-experience','1');
  document.head.appendChild(s);
}
if(!document.querySelector('script[src*="v158-report-premium.js"]')){
  const s=document.createElement('script');
  s.src='assets/v158-report-premium.js?v=158.2';
  s.async=false;
  s.setAttribute('data-ap-v158-report-premium','1');
  document.head.appendChild(s);
}
})();