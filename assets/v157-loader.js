...
if(!document.querySelector('script[src*="v157-editorial-guard.js"]')){
  const s=document.createElement('script');
  s.src='assets/v157-editorial-guard.js?v=158';
  s.async=false;
...
if(!document.querySelector('script[src*="v158-experience.js"]')){
  const s=document.createElement('script');
  s.src='assets/v158-experience.js?v=158';
  s.async=false;
